...
async function main() {
  ...
  for (const alat of alatList) {
    ...
    if (newUrl) {
      if (newUrl.includes('localhost:3000') || newUrl.includes('127.0.0.1:3000') || newUrl.includes('10.0.2.2:3000') || newUrl.includes('192.168.0.192:3000')) {
        newUrl = newUrl.replace('localhost:3000', '192.168.0.195:3000').replace('127.0.0.1:3000', '192.168.0.195:3000').replace('10.0.2.2:3000', '192.168.0.195:3000').replace('192.168.0.192:3000', '192.168.0.195:3000');
